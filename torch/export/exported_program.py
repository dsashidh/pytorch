...
def _get_updated_module_call_graph(
    ...
    old_graph_params_buffers = {**old_graph_signature.inputs_to_parameters, **old_graph_signature.inputs_to_buffers}
    new_graph_params_buffers = {**graph_signature.inputs_to_parameters, **graph_signature.inputs_to_buffers}
    ...
    for node in gm.graph.nodes:
        ...
        # must preserve the old name.
            ...
            if not (
                node.target in new_graph_params_buffers or 
                node.target in graph_signature.input_tokens
            ):
